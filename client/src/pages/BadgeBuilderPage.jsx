...
const BadgeBuilderPage = () => {
  ...
  // Effect to reset foregroundValue and foregroundColor when foregroundType changes
  useEffect(() => {
    const newType = badgeProps.foregroundType;
    setBadgeProps(prev => {
      let currentFgValue = prev.foregroundValue;
      let currentFgColor = prev.foregroundColor;
      let changed = false;
      ...
      if (newType === ForegroundContentType.TEXT && (typeof currentFgValue !== 'string' || currentFgValue.includes('<') || currentFgValue.length > 10 && prev.foregroundType !== ForegroundContentType.TEXT ) ) {
          ...
          currentFgColor = '#FFFFFFFF'; // White for text
          changed = true;
          ...
          currentFgColor = '#000000FF'; // Black for system icons
          changed = true;
          ...
          currentFgColor = '#000000FF'; // Black for uploaded icons (SVG fallback color)
          changed = true;
